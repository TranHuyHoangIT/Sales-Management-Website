        ...
        <div class="col-md-8">
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <button type="button" class="btn btn-primary" id="btnDeleteCustomer">Xóa</button>               
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-2">
                        <button type="button" class="btn btn-primary" id="btnDeleteProduct">Xóa sản phẩm</button>
                    </div>
                    <div class="col-md-4">
                        <button type="button" class="btn btn-primary" id="btnDeleteAllProduct">Xóa tất cả sản phẩm</button>
                    </div>
                    <div class="col-md-2">
                        <button type="button" class="btn btn-primary" id="btnPaying">Thanh toán</button>
                    </div>
                    <div class="col-md-2">   
                        <button type="button" class="btn btn-primary" id="btnUpdateMenu">Cập nhật đơn</button>
                    </div>
                    <div class="col-md-2">
                        <button type="button" class="btn btn-primary" id="btnNewMenu">Đơn mới</button>
                    </div>
                </div>
